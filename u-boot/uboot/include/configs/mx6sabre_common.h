...
//#define CONFIG_RUN_IN_RAM

#ifdef CONFIG_RUN_IN_RAM
#define CONFIG_SKIP_LOWLEVEL_INIT
#define CONFIG_RUN_IN_RAM_DEBUG
#endif

#define CONFIG_IMX_WATCHDOG
#define CONFIG_WATCHDOG_TIMEOUT_MSECS	30000
#define CONFIG_SAIC_AUTO_BOOT
...
#define CONFIG_FEC_XCV_TYPE		RMII  //RGMII
...
#ifdef CONFIG_RUN_IN_RAM
#define CONFIG_SYS_TEXT_BASE		0x10907000
#else
...
//#define CONFIG_IMX_HDMI
	...
	#define CONFIG_FB_BASE	0x4e000000
	...
	#define DISPLAY_HSYNC_WIDTH	24

	#define DISPLAY_VSYNC_START	50
	#define DISPLAY_VSYNC_END		50
	#define DISPLAY_VSYNC_WIDTH	8

	#define DISPLAY_PIX_CLOCK		98561000  //135000000  //(DISPLAY_HSYNC_START + DISPLAY_HSYNC_END + DISPLAY_HSYNC_WIDTH + DISPLAY_WIDTH) * (DISPLAY_VSYNC_START + DISPLAY_VSYNC_END + DISPLAY_VSYNC_WIDTH + DISPLAY_HEIGHT) * refresh rate (60Hz)
	...
	#define IPU_NUM		1//	1  // 1 for IPU1, 2 for IPU2.
	#define DI_NUM		1//	1  // 0 for DI0, 1 for DI1. 
	#define LVDS_PORT	1//	1  // 0 for LVDS0, 1 for LVDS1.
