...
/*-----------------------------------------------------------------------------
 *  Description:  CRC16 table look-up founction
 *  Input      :  pointer to  char array, length of it
 *  Output     :  16-bit CRC verification code
 *---------------------------------------------------------------------------*/
